...
///////////////////////////////////////////////////////////////////////////
        ...
        )
    {
        ...
        {
            ConfigureModelState(createPublisherCommandResponse.Errors);
...
///////////////////////////////////////////////////////////////////////////
    ...
    public async Task<ActionResult<PublisherDto>> GetPublisherById(int publisherId)
    {
        ...
        if (publisherToReturn == null) return NotFound(ModelState);
...
///////////////////////////////////////////////////////////////////////////
        ...
        int publisherId, [FromBody] UpdatePublisherCommand updatePublisherCommand)
    {
        ...
        {
            ConfigureModelState(updatePublisherCommandResponse.Errors);
            return ValidationProblem(ModelState);
        }
