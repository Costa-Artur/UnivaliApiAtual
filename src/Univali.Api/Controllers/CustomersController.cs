...
///////////////////////////////////////////////////////////////////////////
        ...
        )
    {
        ...
        {
            ConfigureModelState(createCustomerCommandResponse.Errors);
...
///////////////////////////////////////////////////////////////////////////
    ...
    public async Task<ActionResult<IEnumerable<CustomerDto>>> GetCustomers()
    {
        ...
        if (customerToReturn == null) return NotFound(ModelState);
...
///////////////////////////////////////////////////////////////////////////
        ...
        UpdateCustomerCommand updateCustomerCommand)
    {
        ...
        {
            ConfigureModelState(updateCustomerCommandResponse.Errors);
            return ValidationProblem(ModelState);
        }

        if(!updateCustomerCommandResponse.Exist) return NotFound(ModelState);
        ...
        [FromRoute] int customerId)
    {
        ...
        if (customerFromDatabase == null) return NotFound(ModelState);
