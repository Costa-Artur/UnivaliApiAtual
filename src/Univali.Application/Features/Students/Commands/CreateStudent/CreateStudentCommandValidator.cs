...
public class CreateStudentCommandValidator : AbstractValidator<CreateStudentCommand>
{
    public CreateStudentCommandValidator()
    {
        ...
        // .Cascade(CascadeMode.Stop)
            ...
            .Must(ValidateCPF)
            .When(s => s.CPF != null, ApplyConditionTo.CurrentValidator)
            .WithMessage("The CPf should be valid number");

        RuleFor(s => s.Age)
            .NotEmpty()
            .WithMessage("You should fill out a Age");
        
        // RuleFor(s => s.AddressStudent)
        //     .NotEmpty()
        //     .WithMessage("You should fill out a Address");
        
        // RuleFor(s => s.RegistrationDate)
        //     .NotEmpty()
        //     .WithMessage("You should fill out a RegistrationDate");
