...
public class CreateCustomerWithAddressesCommandValidator : AbstractValidator<CreateCustomerWithAddressesCommand>
{
    public CreateCustomerWithAddressesCommandValidator()
    {
        RuleFor(c => c.Name)
            .NotEmpty()
